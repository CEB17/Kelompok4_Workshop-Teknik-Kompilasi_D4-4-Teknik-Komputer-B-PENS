...
String Button = "Start",lastButton;
...
void Start() {
  Button = "Auto";
  String json = "{\"Tanggal\":\""+String(data_tanggal)+"\",\"Waktu\":\""+String(data_jam)+"\",\"Kondisi_lampu\":\""+kondisi_lampu+"\", \"Data_potensio\":\""+ String(data_potensio) +"\"}";
